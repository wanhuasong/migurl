...
func main() {
	...
	m, err := migration.NewMigration(cfgFile, apiBaseURL, qiniuPublicDomain, genericStorageBaseURL, newBaseURL)
	if err != nil {
...
func initFlags() {
	...
	flag.StringVar(&newBaseURL, "new-base-url", "", "new-base-url used for replacing")
